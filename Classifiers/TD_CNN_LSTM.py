...
extract_path = '/home/argha/Documents/mmDoppler/baseline/RadHAR/Data/Train'
...
def full_3D_model(input_x, input_y, reg = 0, num_feat_map = 16, summary=False):
    ...
    model = Sequential()
    # 1st layer group
    model.add(TimeDistributed(Conv2D(32, (3, 3), strides=(1, 1), input_shape=(10, 32, 32), padding="same", activation="relu")))
    # 2nd layer group
